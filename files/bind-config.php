...
/*
	...
	This file should be read-only to the user whom the bdind configuration scripts are running as.
*/

/*
	API Configuration
*/
$config["api_url"]		    = "@NM_API_URL@";			    // Application Install Location
$config["api_server_name"]	= "@NM_API_SERVER_NAME@";		// Name of the DNS server (important: part of the authentication process)
$config["api_auth_key"]		= "@NM_API_AUTH_KEY@";			// API authentication key
